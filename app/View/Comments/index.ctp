<div class="comments index">
	...
	<tr>
		...
		<td><?php echo h($comment['Comment']['nama']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['email']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['komentar']); ?>&nbsp;</td>
		...
		<td>
			<?php echo $this->Html->link($comment['Gallery']['title'], array('controller' => 'galleries', 'action' => 'view', $comment['Gallery']['id'])); ?>
		</td>
