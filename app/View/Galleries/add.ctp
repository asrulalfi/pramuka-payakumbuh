...
<div id="content_bottom">
  ...
  <?php echo $this->Form->create('Gallery', 
    ...
    <ul id="entri_data">
    	<li>
          <p>
            <?php echo $this->Form->input('Gallery.user_id', array('type' => 'hidden', 'value' => $this->Session->read('Auth.User.id'))); ?>
        ...
        <li>
        	<p><?php echo $this->Form->input('GalleryDetail.0.photo', array(
        						'type' => 'file',
        						'label' => __('Attach an image')
        					) 
        			); ?>
        	</p>
        </li>
        <li>
        	<p><?php echo $this->Form->input('GalleryDetail.1.photo', array(
        						'type' => 'file',
        						'label' => __('Attach an image')
        					) 
        			); ?>
